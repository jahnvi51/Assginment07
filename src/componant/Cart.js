...
export const Cart = () => {
  const [productsArray, setProductsArray] = useState([
    { name: "Maggie", qty: 0, price: 1000 },
    { name: "Pasta", qty: 0, price: 500 },
    { name: "Noodles", qty: 0, price: 770 },
    { name: "Coco", qty: 0, price: 650 },
    { name: "Butter", qty: 0, price: 50 },
    { name: "Cheese", qty: 0, price: 600 }
  ]);
